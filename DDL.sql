...
CREATE TABLE `lms`.`user_engagement_mis` (
  `Date_Time` DATETIME NOT NULL,
  `Cpu_Count` INT NOT NULL,
  `Cpu_Working_Time` DOUBLE NOT NULL,
  `Cpu_idle_Time` VARCHAR(45) NOT NULL,
  ...
  ALTER TABLE `lms`.`user_engagement_mis` 
CHANGE COLUMN `Date_Time` `Date_Time` DATETIME NULL ,
CHANGE COLUMN `Cpu_Count` `Cpu_Count` INT NULL ,
CHANGE COLUMN `Cpu_Working_Time` `Cpu_Working_Time` DOUBLE NULL ,
CHANGE COLUMN `Cpu_idle_Time` `Cpu_idle_Time` VARCHAR(45) NULL ,
CHANGE COLUMN `cpu_percent` `cpu_percent` DOUBLE NULL ,
CHANGE COLUMN `Usage_Cpu_Count` `Usage_Cpu_Count` INT NULL ,
CHANGE COLUMN `number_of_software_interrupts_since_boot` `number_of_software_interrupts_since_boot` VARCHAR(45) NULL ,
CHANGE COLUMN `number_of_system_calls_since_boot` `number_of_system_calls_since_boot` INT NULL ,
CHANGE COLUMN `number_of_interrupts_since_boot` `number_of_interrupts_since_boot` VARCHAR(45) NULL ,
CHANGE COLUMN `cpu_avg_load_over_1_min` `cpu_avg_load_over_1_min` DOUBLE NULL ,
CHANGE COLUMN `cpu_avg_load_over_5_min` `cpu_avg_load_over_5_min` DOUBLE NULL ,
CHANGE COLUMN `cpu_avg_load_over_15_min` `cpu_avg_load_over_15_min` DOUBLE NULL ,
CHANGE COLUMN `system_total_memory` `system_total_memory` BIGINT NULL ,
CHANGE COLUMN `system_used_memory` `system_used_memory` BIGINT NULL ,
CHANGE COLUMN `system_free_memory` `system_free_memory` BIGINT NULL ,
CHANGE COLUMN `system_active_memory` `system_active_memory` BIGINT NULL ,
CHANGE COLUMN `system_inactive_memory` `system_inactive_memory` BIGINT NULL ,
CHANGE COLUMN `system_buffers_memory` `system_buffers_memory` BIGINT NULL ,
CHANGE COLUMN `system_cached_memory` `system_cached_memory` BIGINT NULL ,
CHANGE COLUMN `system_shared_memory` `system_shared_memory` BIGINT NULL ,
CHANGE COLUMN `system_avalible_memory` `system_avalible_memory` BIGINT NULL ,
CHANGE COLUMN `disk_total_memory` `disk_total_memory` BIGINT NULL ,
CHANGE COLUMN `disk_used_memory` `disk_used_memory` BIGINT NULL ,
CHANGE COLUMN `disk_free_memory` `disk_free_memory` BIGINT NULL ,
CHANGE COLUMN `disk_read_count` `disk_read_count` BIGINT NULL ,
CHANGE COLUMN `disk_write_count` `disk_write_count` BIGINT NULL ,
CHANGE COLUMN `disk_read_bytes` `disk_read_bytes` BIGINT NULL ,
CHANGE COLUMN `disk_write_bytes` `disk_write_bytes` BIGINT NULL ,
CHANGE COLUMN `time_spent_reading_from_disk` `time_spent_reading_from_disk` BIGINT NULL ,
CHANGE COLUMN `time_spen_writing_to_disk` `time_spen_writing_to_disk` BIGINT NULL ,
CHANGE COLUMN `time_spent_doing_actual_I/Os` `time_spent_doing_actual_I/Os` BIGINT NULL ,
CHANGE COLUMN `number_of_bytes_sent` `number_of_bytes_sent` BIGINT NULL ,
CHANGE COLUMN `number_of_bytes_received` `number_of_bytes_received` BIGINT NULL ,
CHANGE COLUMN `number_of_packets_sent` `number_of_packets_sent` BIGINT NULL ,
CHANGE COLUMN `number_of_packets_recived` `number_of_packets_recived` BIGINT NULL ,
CHANGE COLUMN `total_number_of_errors_while_receiving` `total_number_of_errors_while_receiving` INT NULL ,
CHANGE COLUMN `total_number_of_errors_while_sending` `total_number_of_errors_while_sending` INT NULL ,
CHANGE COLUMN `total_number_of_incoming_packets_which_were_dropped` `total_number_of_incoming_packets_which_were_dropped` INT NULL ,
CHANGE COLUMN `total_number_of_outgoing_packets_which_were_dropped` `total_number_of_outgoing_packets_which_were_dropped` INT NULL ,
CHANGE COLUMN `boot_time` `boot_time` TIME NULL ,
CHANGE COLUMN `keyboard` `keyboard` DOUBLE NULL ,
CHANGE COLUMN `mouse` `mouse` DOUBLE NULL ,
CHANGE COLUMN `technology` `technology` VARCHAR(40) NULL ,
CHANGE COLUMN `files_changed` `files_changed` VARCHAR(45) NULL ;